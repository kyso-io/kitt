...
:docsdir: ../..
:includedir: _include
:imagesdir: {docsdir}/images/_include/application-configuration
...
These properties are stored in **MongoDB** in the collection **KysoSettings**, which is basically a key-value list.
