...
# Fixed values
export ACTIVITY_FEED_CONSUMER_PORT="3000"
...
apps_activity_feed_consumer_export_variables() {
  ...
  export ACTIVITY_FEED_CONSUMER_SERVICE_TMPL="$_service_tmpl"
  # Files
...
apps_activity_feed_consumer_install() {
  ...
  _service_tmpl="$ACTIVITY_FEED_CONSUMER_SERVICE_TMPL"
  ...
  sed \
    ...
    -e "s%__SERVER_PORT__%$ACTIVITY_FEED_CONSUMER_PORT%" \
    "$_env_tmpl" |
