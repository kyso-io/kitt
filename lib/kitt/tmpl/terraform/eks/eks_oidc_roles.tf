...
module "aws_load_balancer_controller" {
  ...
  role_name = "${var.aws_config["cluster_name"]}-aws-load-balancer-controller"
...
resource "aws_iam_policy" "aws_load_balancer_controller_policy" {
  name        = "${var.aws_config["cluster_name"]}-aws-load-balancer-controller-policy"
  description = "Policy for the AWS Load Balancer Controller process"
  # Policy taken from
  # https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/v2.5.1/docs/install/iam_policy.json
  policy = <<EOF
{
    "Version": "2012-10-17",
    "Statement": [
